  ...
  data () {
    return {
      ...
      headers: [
        ...
        { text: 'Sales Bill No',  value: 'billNumber', class: 'primary white--text' },
        { text: 'Bill Date', value: 'billDate', class: 'primary white--text' },
        { text: 'Customer', value: 'customerName', class: 'primary white--text' },
