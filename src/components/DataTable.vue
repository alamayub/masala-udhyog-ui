      ...
      <table>
        <thead>
          <tr>
            ...
            <th>Item Name</th>
            <th style="text-align: start; width: 120px;">Rate(Rs.)</th>
            <th style="text-align: start; width: 120px;">Quantity</th>
            <th style="text-align: start; width: 120px;">Amount(Rs.)</th>
          </tr>
        </thead>
        <tbody>
...
export default {
  ...
  methods: {
    ...
    print(item) {
      console.log(item)
      const p1 = '.print { display: block; border: .5px solid black; font-family: sans-serif; }'
      ...
      const head = '.head { padding: 15px; display: flex; justify-content: space-between; }'
      const table = 'table { width: 100%; border-collapse: collapse; } tfoot { font-weight: bold; } tfoot td:first-child { text-align: end; }'
      const td = 'table td, table th { padding: 7px 15px; border: 1px solid black; }'
