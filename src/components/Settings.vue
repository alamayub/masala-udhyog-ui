<template>
  <div class="settings-class">
    <v-card id="settings" class="py-2 px-4" color="rgba(0, 0, 0, .3)" dark flat link min-width="100" style="position: fixed; top: 115px; right: -35px; border-radius: 8px;">
      ...
      <v-card class="text-center mb-0" width="300">
        <v-card-text>
          ...
          <v-item-group v-model="color">
            <v-item v-for="color in colors" :key="color" :value="color" class="mr-1">
